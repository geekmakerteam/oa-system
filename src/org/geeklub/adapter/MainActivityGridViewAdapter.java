...
public class MainActivityGridViewAdapter extends BaseAdapter{
	...
	public MainActivityGridViewAdapter(Context context,ArrayList<MetroButton> mdata,int position){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView==null){
			convertView = mlayoutInflater.inflate(R.layout.main_activity_gridview_item, null);
			viewHolder = new ViewHolder();
			viewHolder.im_metro_picture = (ImageView) convertView.findViewById(R.id.main_activity_gridview_item_imageview_src);
			viewHolder.tv_metro_name = (TextView) convertView.findViewById(R.id.main_activity_gridview_item_imageview_title);
